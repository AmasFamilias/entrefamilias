...
<div class="w-full px-4 sm:px-6 lg:px-8 mt-6 sm:mt-8">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
        @forelse ($vacantes as $vacante)
            <div class="relative bg-white shadow-lg rounded-xl overflow-hidden transition-transform duration-300 hover:scale-[1.03]">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-600 text-sm mt-2 line-clamp-3">{{ Str::limit($vacante->descripcion, 150) }}</p>
