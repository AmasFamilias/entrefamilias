                    ...
                    <div class="prose prose-lg max-w-none">
                        ...
                        <div class="space-y-16">
                            ...
                            <section class="bg-gray-50 rounded-xl p-6 sm:p-8">
                                <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">1. Información que recopilamos</h2>
                                <div class="space-y-6">
                            ...
                            <section class="bg-white rounded-xl p-6 sm:p-8 border border-gray-100">
                                <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">2. Uso de la información</h2>
                                <div class="space-y-6">
                            ...
                            <section class="bg-gray-50 rounded-xl p-6 sm:p-8">
                                <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">3. Compartir información</h2>
                                <div class="space-y-6">
                                    <div class="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <section class="bg-white rounded-xl p-6 sm:p-8 border border-gray-100">
                                <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">4. Tus derechos</h2>
                                <div class="space-y-6">
                                    <div class="bg-gray-50 rounded-lg p-4">
                            ...
                            <!-- Sección 5: Seguridad -->
                            <section class="bg-gray-50 rounded-xl p-6 sm:p-8">
                                <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">5. Seguridad</h2>
                                <div class="space-y-6">
                                    <div class="bg-white rounded-lg p-4 shadow-sm">
                            ...
                            <section class="bg-white rounded-xl p-6 sm:p-8 border border-gray-100">
                                <h2 class="text-2xl sm:text-3xl font-semibold text-gray-900 mb-6">6. Cambios en la política</h2>
                                <div class="space-y-6">
                                    <div class="bg-gray-50 rounded-lg p-4">
                                        <p class="text-gray-700">
