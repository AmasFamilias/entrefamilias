<footer class="relative bg-cover bg-center text-white py-16" style="background-image: url('<?php echo e(asset('images/footer_web.png')); ?>');">
    <div class="container mx-auto text-center space-y-8">
        ...
        <div class="flex flex-col sm:flex-row justify-center items-center space-y-4 sm:space-y-0 sm:space-x-12">
            ...
            <div class="font-segoe_ui flex items-center text-sm md:text-base">
                <img src="<?php echo e(asset('images/mobile.png')); ?>" alt="Icono Teléfono" class="h-9 w-6 mr-3">
            ...
            <!-- Enlace de Correo -->
            <div class="font-segoe_ui flex items-center text-sm md:text-base">
                <img src="<?php echo e(asset('images/icono_mensaje.png')); ?>" alt="Icono Email" class="h-7 w-9 mr-3">
...
<?php /**PATH C:\Users\SergioOviedoVarela\Desktop\entrefamilias\resources\views/layouts/footer.blade.php ENDPATH**/ ?>